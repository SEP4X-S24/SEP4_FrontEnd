...
function HomeSugestion({ sugestion }: { sugestion: Suggestion }) {
  const [title, setWeather] = React.useState("Rain");
  ...
  return (
    <div className={classes.sugestion} >
      ...
      <div className="row">
        <div className="col">
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorum consequatur ea velit cum dignissimos sapiente veniam voluptates nemo quibusdam ex porro tenetur ab, ducimus accusantium hic a quidem iure voluptas.</p>
        </div>
        <div className="col">
        <ul>
        {sugestion.items.map((item, index) => (
